...
% ---------------------
% signal  - the time domain signal (1D) to be decomposed  被分解的时域信号（ID）
% alpha   - the balancing parameter of the data-fidelity constraint  数据保真度约束的平衡参数
% tau     - time-step of the dual ascent ( pick 0 for noise-slack )   双上升时间步长(噪声松弛取0)
% K       - the number of modes to be recovered    要恢复的模式数
% DC      - true if the first mode is put and kept at DC (0-freq)   如果将第一模式设置为DC (0-freq)，则为true
% init    - 0 = all omegas start at 0  所有都从0开始
%                    1 = all omegas start uniformly distributed
%                    2 = all omegas initialized randomly
% tol     - tolerance of convergence criterion; typically around 1e-6 收敛准则的容差;通常大约e-6
%
% Output:
% -------
% u       - the collection of decomposed modes  分解模式的集合
% u_hat   - spectra of the modes  spectra of the modes
% omega   - estimated mode center-frequencies 估计的模式的中心频率
%
